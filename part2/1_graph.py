...
def main(n,vruddhi,ends_with,two_vowels,last_second,total,count_list,seed_analyze=0):
	...
	with open("part"+str(n)+"_algo_file.txt") as f:
		input_dict = json.loads(f.read())
	f1 = open("Step1/input_graph.txt",'wb')
	f2 = open("Step1/seeds.txt",'wb')
	f3 = open("Step1/gold_labels.txt",'wb')
	...
	with io.open("nodes_dict.txt", "w", encoding="utf8") as ft:
